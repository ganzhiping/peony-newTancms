...
$(function() {
    ...
    jQuery.focus = function(slid) {
        ...
        var btn = "<div class='btnBg'></div><div class='box'><div class='winBox'><div class='btn scroll'>";
        for(var i=0; i < len; i++) {
            var ii = i+1;
            btn += "<span>"+ii+"</span>";
        }
        btn += "</div></div></div><div class='preNext pre'></div><div class='preNext next'></div>";
        $(slid).append(btn);
        $(slid).find("div.btnBg");
